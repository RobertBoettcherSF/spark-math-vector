...
is
   ...
   package Real_Functions is new Ada.Numerics.Generic_Elementary_Functions (Vectors.Real);
   ...
   function "*" (Scalar : Vectors.Real; Vec : Vector) return Vector is
      Result : Vector;
   begin
      for I in 1 .. Dimension loop
   ...
   function Dot_Product (Left, Right : Vector) return Vectors.Real is
      Sum : Vectors.Real := 0.0;
   begin
      for I in 1 .. Dimension loop
   ...
   function Norm (Vec : Vector) return Vectors.Real is
      Sum_Squares : Vectors.Real := 0.0;
   begin
      for I in 1 .. Dimension loop
...
end Vectors.N_Dimensional_Vectors;
